...
<template>
  <nav px8 py4 mb-4 border="b gray-400/10" flex="~ gap2" text-xl items-center>
    ...
    <div flex="~ gap4" items-center>
      <button class="icon-btn !outline-none p1" :class="isDebug ? '!text-red bg-red:10 rounded' : ''" @click="toggleDebug()">
        <div i-carbon-debug />
      </button>
      <a class="icon-btn" i-carbon-logo-github rel="noreferrer" href="https://github.com/" target="_blank" title="GitHub" />
